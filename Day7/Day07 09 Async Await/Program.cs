/*Async and Await in C# are used to write asynchronous code 
that is easier to understand and maintain. These keywords are 
part of the Task-based Asynchronous Pattern (TAP) introduced in 
.NET Framework 4.5. They allow you to perform tasks asynchronously,
 meaning the application can continue executing other code without 
waiting for the task to complete, which is particularly useful for 
I/O-bound operations like file access, database queries, and web requests.*/

using System;
using System.Threading.Tasks;


namespace Day07_09_Async_Await
{
    class Program
    {
        ...
        public static async Task Perform()
        {
            ...
            // Asynchronously wait for 20000 milliseconds (3 seconds)
