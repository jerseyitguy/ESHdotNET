/*Lambda expressions in C# are a concise way to write anonymous
 * methods using a special syntax. They are particularly 
 * useful in situations  where you want to create short, 
 * inline functions without having to define a full method. 
 * Lambda expressions are often used with
delegates or in LINQ queries to define operations 
on collections.
*/
...
namespace Day07_08_Lambda_expression
{
    ...
    class Program
    {
            ...
            var products = new List<Product>
        {
            ...
            // Use LINQ to filter the list of products, keeping only
            // those with a price greater than 50
